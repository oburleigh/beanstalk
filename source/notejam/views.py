...
from notejam import application, db, login_manager, mail
...
@application.route('/notes/create/', methods=['GET', 'POST'])
@login_required
def create_note():
...
@application.route('/notes/<int:note_id>/edit/', methods=['GET', 'POST'])
@login_required
...
@application.route('/notes/<int:note_id>/')
@login_required
...
@application.route('/notes/<int:note_id>/delete/', methods=['GET', 'POST'])
@login_required
...
@application.route('/pads/create/', methods=['GET', 'POST'])
@login_required
def create_pad():
    pad_form = PadForm()
...
@application.route('/pads/<int:pad_id>/edit/', methods=['GET', 'POST'])
@login_required
def edit_pad(pad_id):
...
@application.route('/pads/<int:pad_id>/')
@login_required
...
@application.route('/pads/<int:pad_id>/delete/', methods=['GET', 'POST'])
@login_required
...
def forgot_password():
    ...
    if form.validate_on_submit():
        ...
        message = Message(
            ...
            sender="from@notejamapplication.com",
...
@application.template_filter('smart_date')
